...
<template>
  ...
  <a href="#">
    ...
    src="https://images8.alphacoders.com/106/1060161.jpg" 
    alt="image description">
  </a>
  <figcaption 
  class="absolute px-4 text-lg text-white bottom-6">
  ...
  <div class="" >
        ...
        <section class=" m-9 bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-19 z-10 relative">
                
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Aqui encontraras todos los personajes</h1>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">estas listo para esta aventura</p>
                
                
            </div>
            <div class="bg-gradient-to-b from-blue-50 to-transparent dark:from-blue-900  absolute top-0 left-0 z-0"></div>
        </section>
      ...
      <div v-for="item in items" :key="item.id">
        ...
        >
          ...
          <div class="flex flex-col justify-between p-4 leading-normal">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 flex justify-start gap-3">
              ...
              <span class="leading-3">{{ item.status }} - {{ item.species }}</span>
            </p>
            <p>Last known location:</p>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              {{ item.location.name }}
            </p>
            <p>Last First seen in:</p>
            <!-- <p v-for="nameEpisode in nameEpisodes" :key="nameEpisode.id" class="mb-3 font-normal text-gray-700 dark:text-gray-400">{{ nameEpisode.name }}</p> -->
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
              {{ getName(item.episode) }}
            </p>
          </div>
        </a>
      </div>
...
export default {
  ...
  methods: {
    fetchCharacters() {
      ...
      const apiCharacter = api + 'character?page=' + this.currentPage
